(()=>{var e={};e.id=778,e.ids=[778],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},9021:e=>{"use strict";e.exports=require("fs")},3873:e=>{"use strict";e.exports=require("path")},4950:(e,t,i)=>{"use strict";i.r(t),i.d(t,{patchFetch:()=>h,routeModule:()=>g,serverHooks:()=>f,workAsyncStorage:()=>p,workUnitAsyncStorage:()=>v});var a={};i.r(a),i.d(a,{POST:()=>m});var r=i(2706),o=i(8203),n=i(5994),s=i(9187),l=i(9021),d=i.n(l),c=i(3873),u=i.n(c);async function m(e){try{let{title:t,description:i,date:a,icon:r,content:o,colors:n,slug:l}=await e.json();if(!t||!i||!a||!r||!o||!l||!n)return s.NextResponse.json({error:"Missing required fields"},{status:400});let c=u().join(process.cwd(),"app/blog",l);if(d().existsSync(c))return s.NextResponse.json({error:"Blog post with this slug already exists"},{status:400});d().mkdirSync(c,{recursive:!0});let m=new Date(a).toLocaleDateString("en-US",{month:"long",day:"numeric",year:"numeric"}),g=[`from-${n[0]}-400 via-${n[1]}-300 to-${n[2]}-300`,`from-${n[2]}-300 via-${n[3]}-400 to-${n[4]}-300`,`from-${n[4]}-300 via-${n[5]}-300 to-${n[0]}-400`],p=`'use client';
...
export default function ${t.replace(/\s+/g,"")}Post() {
  ...
  return (
    <div className="relative min-h-screen bg-white dark:bg-gray-900" ref={contentRef}>
      ...
      <motion.div 
        className="fixed top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-${n[0]}-500 via-${n[3]}-500 to-${n[5]}-500 z-50"
      ...
      >
        ...
        <div className="flex items-start mb-8">
          <div className="mr-5 flex-shrink-0">
            <ImageIcon 
              src="${r}"
              size="lg"
              borderGradient="from-${n[0]}-200 via-${n[2]}-300 to-${n[4]}-200"
          ...
          <div className="relative p-4 rounded-lg bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900">
            <div className="flex items-center relative z-10">
              ...
              <div className="flex">
                <button 
                  onClick={togglePlay}
                  className="w-8 h-8 flex items-center justify-center rounded-full bg-${n[0]}-100 dark:bg-${n[0]}-900/30 text-${n[0]}-700 dark:text-${n[0]}-400 hover:bg-${n[0]}-200 dark:hover:bg-${n[0]}-800/40 transition-colors"
                >
                  {isPlaying ? (
                ...
                <button 
                  ...
                  className={\`ml-2 w-8 h-8 flex items-center justify-center rounded-full \${
                    isLooping 
                      ? 'bg-${n[3]}-100 dark:bg-${n[3]}-900/30 text-${n[3]}-700 dark:text-${n[3]}-400 hover:bg-${n[3]}-200 dark:hover:bg-${n[3]}-800/40' 
            ...
            <div className="mt-4 mx-1" ref={progressBarRef} onClick={handleProgressBarClick}>
              <div className="h-1 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden cursor-pointer">
                <div 
                  className="h-full bg-gradient-to-r from-${n[1]}-300 to-${n[3]}-300 rounded-full" 
        ...
        >
          <GrainyGradient colorClass="bg-gradient-to-r ${g[0]}" />
        </motion.div>
        ...
        <motion.div className="space-y-6 text-gray-800 dark:text-gray-200">
          ...
          >
            <GrainyGradient colorClass="bg-gradient-to-r ${g[1]}" />
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <GrainyGradient colorClass="bg-gradient-to-r ${g[2]}" />
          </motion.div>
        </motion.div>
      </motion.div>
    </div>
  );
}`;return d().writeFileSync(u().join(c,"page.tsx"),p),s.NextResponse.json({success:!0,slug:l})}catch(e){return console.error("Error creating blog post:",e),s.NextResponse.json({error:"Failed to create blog post"},{status:500})}}let g=new r.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/blog/route",pathname:"/api/blog",filename:"route",bundlePath:"app/api/blog/route"},resolvedPagePath:"/Users/robertzhang/Documents/GitHub/robert/app/api/blog/route.ts",nextConfigOutput:"",userland:a}),{workAsyncStorage:p,workUnitAsyncStorage:v,serverHooks:f}=g;function h(){return(0,n.patchFetch)({workAsyncStorage:p,workUnitAsyncStorage:v})}},6487:()=>{},8335:()=>{}};var t=require("../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),a=t.X(0,[638,452],()=>i(4950));module.exports=a})();